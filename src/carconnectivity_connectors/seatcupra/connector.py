...
class Connector(BaseConnector):
            ...
            if 'vehicles' in data and data['vehicles'] is not None:
                for vehicle_dict in data['vehicles']:
                    if 'vin' in vehicle_dict and vehicle_dict['vin'] is not None:
                        ...
                        if vehicle is None:
                            vehicle = SeatCupraVehicle(vin=vin, garage=garage, managing_connector=self, initialization=garage.get_initialization(vin))
    ...
    def _set_vehicle_offline(self, vehicle: SeatCupraVehicle, offline_time: datetime) -> None:
        with vehicle.online_timeout_timer_lock:
